...
func (MeshType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mesh_087ee8cca08d2085, []int{0}
}
...
func (*TargetMesh) Descriptor() ([]byte, []int) {
	return fileDescriptor_mesh_087ee8cca08d2085, []int{1}
}
...
func (*KubeLocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_mesh_087ee8cca08d2085, []int{2}
}
...
func init() { proto.RegisterFile("mesh.proto", fileDescriptor_mesh_087ee8cca08d2085) }

var fileDescriptor_mesh_087ee8cca08d2085 = []byte{
	// 533 bytes of a gzipped FileDescriptorProto
	,
}
